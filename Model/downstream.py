...
from imu_lib.classification_head import Head, ZeroShotClassification
from imu_lib.clip_model import ClipPLModel
from imu_lib.train_modules import ClassificationModule
from imu_lib.data_modules import SupervisedEgo4dDataModule
...
def train_downstream(configs):
    ...
    path_load_pretrained_imu_encoder = train_hparams.get(
        "/home/tzh/Project/GaitFreezing/data/imu2clip/i2c_s_i_t_v_ie_mw2_w_5.0_master_imu_encoder.pt"
    )
